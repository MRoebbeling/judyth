...
Future<List<MemoryModel>> getTaskList(List memoryList) async {
    ...
    final List<Map<String, Object?>> memoryMaps = await db.rawQuery('SELECT * FROM judyth_task WHERE parentId IS (${memoryList.last})');
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      return Card(
                                        ...
                                        shape: Border(
                                          bottom: BorderSide(
                                          color: const Color.fromARGB(120, 212, 212, 212), 
                                          width: 1.0,
                                          ),
                                        ),
                                        child: ListTile(
                                          ...
                                          */
                                          ...
                                          leading:  InkWell(
                                            onTap: () {
                                              ...
                                              changeMemmoryStatus(snapshot.data![index].id);
                                              setState(() {
                                                //_textinput = _textcontroler.text;
                                              });
                                            },
                                            child: Icon(
                                              (snapshot.data![index].status == 0) ? Icons.radio_button_unchecked : Icons.error_outline, 
                                              color: Color.fromARGB(255, 9, 7, 7),
                                              size: 30,
                                            ),
                                          ...
                                          */
                                          ...
                                          trailing: InkWell(
                                            onTap: () {
                                              ...
                                              Navigator.push(
                                                context,
                                                MaterialPageRoute(builder: (context) => Mainscreen(taskName: snapshot.data![index].task, memoryList: tmpList),),
                                              );
                                              setState(() {
                                                //_textinput = _textcontroler.text;
                                              });
                                            },
                                            child: (snapshot.data![index].childIDs != 0) ? Icon(
